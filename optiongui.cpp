    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    Connect(NUMBER_UPDATE_ID, wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(MyFrame1::onQuoteUpdate));
...
void MyFrame1::onQuoteUpdate(wxCommandEvent& evt)	{
	int myint =evt.GetInt();
	grid_1->SetCellValue(0,2,wxString::Format(wxT("%i"),myint));
